...
public class SpellsOld {
    ...
    public static ArrayList<SpellACE> REGISTRY = new ArrayList<>();
    ...
    public static SpellACE getSpellByName(String name)
    {
        for (SpellACE spell : REGISTRY) {
    ...
    public static List<SpellACE> getSpellsByElement(String element)
    {
        List<SpellACE> spells = new ArrayList<>();
    ...
    public static List<SpellACE> getSpellsByTier(int tier)
    {
        List<SpellACE> spells = new ArrayList<>();
        REGISTRY.forEach(spell ->
        {
    ...
    public static List<SpellACE> getSpellsByStyle(String style)
    {
        List<SpellACE> spells = new ArrayList<>();
        REGISTRY.forEach(spell -> {
            if(spell.getCastingType().equals(style))
            {
                spells.add(spell);
            }
        });
